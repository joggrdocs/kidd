...
describe('createDotDirectoryClient()', () => {
  ...
  describe('global', () => {
    it('should return a DotDirectory with the global path', () => {
      const client = createDotDirectoryClient({ dirs: { global: DIR_NAME, local: DIR_NAME } })
  ...
  describe('local', () => {
    it('should return a DotDirectory when inside a project root', () => {
  ...
  describe('protect', () => {
    it('should protect a file across DotDirectory instances from the same client', () => {
      const client = createDotDirectoryClient({ dirs: { global: DIR_NAME, local: DIR_NAME } })
